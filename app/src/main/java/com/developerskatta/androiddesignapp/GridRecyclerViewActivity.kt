...
class GridRecyclerViewActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // insert data in list
        gridList.add(GridModel(1, R.drawable.google_plus, "Google Plus"))
        gridList.add(GridModel(2, R.drawable.facebook, "Facebook"))
        gridList.add(GridModel(3, R.drawable.youtube, "YouTube"))
        gridList.add(GridModel(4, R.drawable.twitter, "Twitter"))
        gridList.add(GridModel(5, R.drawable.linkedin, "LinkedIn"))
        gridList.add(GridModel(6, R.drawable.skype, "Skype"))
        gridList.add(GridModel(7, R.drawable.nature, "Nature"))
